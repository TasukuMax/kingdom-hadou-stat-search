...
const TOOL_PAGE_DEFS = [
  {
    ...
    path: "power.html",
    category: "検索 / 育成",
    description: "主将候補検索と、シーズン3資料ベースの部隊戦力算出をまとめた基本ページです。",
    chips: ["主将候補", "S3戦力算出", "連鎖率"]
  },
  {
    key: "equipment",
    path: "equipment.html",
  ...
  },
  {
    ...
    path: "army.html",
    category: "25体軍勢",
    description: "育成済み武将から主将候補を5体選び、その主将を軸に残り20枠を提案する軍勢ページです。",
    chips: ["主将5体選択", "副将・補佐提案", "CSV実測"]
  },
  {
    key: "advanced",
    path: "advanced.html",
...
const elements = {
  ...
  powerCalcSoldier: document.querySelector("#powerCalcSoldier"),
  powerCalcAttack: document.querySelector("#powerCalcAttack"),
  powerCalcDefense: document.querySelector("#powerCalcDefense"),
  powerCalcWar: document.querySelector("#powerCalcWar"),
  powerCalcStrategy: document.querySelector("#powerCalcStrategy"),
  powerCalcSoldierBuff: document.querySelector("#powerCalcSoldierBuff"),
  powerCalcAttackBuff: document.querySelector("#powerCalcAttackBuff"),
  powerCalcDefenseBuff: document.querySelector("#powerCalcDefenseBuff"),
  powerCalcWarBuff: document.querySelector("#powerCalcWarBuff"),
  powerCalcStrategyBuff: document.querySelector("#powerCalcStrategyBuff"),
  powerCalcResetButton: document.querySelector("#powerCalcResetButton"),
  ...
  armySuggestCommandersButton: document.querySelector("#armySuggestCommandersButton"),
  armyAutoSelectCommandersButton: document.querySelector("#armyAutoSelectCommandersButton"),
  armyFinalizeButton: document.querySelector("#armyFinalizeButton"),
  armyClearCommanderSelectionButton: document.querySelector("#armyClearCommanderSelectionButton"),
  armyCommanderWizardSummaryGrid: document.querySelector("#armyCommanderWizardSummaryGrid"),
  armySelectedCommanderStrip: document.querySelector("#armySelectedCommanderStrip"),
  armyCommanderHelp: document.querySelector("#armyCommanderHelp"),
